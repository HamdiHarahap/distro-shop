<x-layout title="Loginpage">
    <section class="flex min-h-screen items-center flex-col justify-center">
        <div class="flex flex-col items-center">
            <h2 class="font-bold text-xl">Log in to DistroShop</h2>
            @if (session('error'))
            ...
            <form action="{{route('login.post')}}" class="mx-auto mt-6 flex flex-col gap-3" method="POST">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" id="name" name="name" class="border-2 bg-transparent rounded-md px-2 py-1 w-[25rem] outline-blue-600">
                    @error('name')
